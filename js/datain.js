...
class DataIN{
    constructor(d1, d2, InterestData){
        ...
        var all_nomal_int_arr= backdata_arr.filter(x => x.interested <=int_line && x.interested>not_intline );
        ...
        // //3時間から1日 
        // else if (bet_time<86400 && bet_time>=3600){
        //     console.log("info 3hour~1d")

        //     //時間変化ラベル作成

        //     for(let h=user_intime ;h<user_outtime ;h=h+3600){
        //         label_unix_in.push(user_intime+h)
        //     }
